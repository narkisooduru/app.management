        ...
        Column(modifier = Modifier.padding(innerPadding)) {
            ...
            Card(
                ...
                Row(
                    ...
                    Spacer(modifier = Modifier.width(16.dp))
                    Column {
                        Text("Add Doctor", fontSize = 18.sp, color = Color.Black)
                        Text("Register new Doctor details", fontSize = 14.sp, color = Color.Black)
                    }
                }
            }
            ...
            Card(
                ...
                Row(
                    ...
                    Spacer(modifier = Modifier.width(16.dp))
                    Column {
                        Text("Add Nurse", fontSize = 18.sp, color = Color.Black)
                        Text("Register new Nurse details", fontSize = 14.sp, color = Color.Black)
                    }
                }
            }
        }
